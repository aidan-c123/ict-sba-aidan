...
info, summary, club_list = st.tabs(["View Data", "Summary", "Add/update club list"])
...
with info:
    ...
    st.session_state.df = st.data_editor(
        ...
        column_config={
            ...
            "Type": st.column_config.SelectboxColumn(options = ["Income", "Expense"], required=True),
            "Category": st.column_config.SelectboxColumn(options=list(cat["Name"]), required=True),
            "UUID": None
        },
        num_rows="dynamic"
    )
